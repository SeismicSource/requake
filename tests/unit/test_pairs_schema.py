...
class TestPairsSchema(unittest.TestCase):
    ...
    def _assert_pair_types(self, pair):
        ...
        self.assertGreaterEqual(pair.lag_sec, 0.0, "lag_sec should be non-negative")
    ...
    def test_pairs_csv_headers(self):
        ...
        evid1, evid2, trace_id, orig_time1, lon1, lat1, depth_km1, mag_type1, mag1,
        orig_time2, lon2, lat2, depth_km2, mag_type2, mag2, lag_samples, lag_sec, cc_max
        """
