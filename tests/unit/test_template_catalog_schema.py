...
class TestTemplateCatalogSchema(unittest.TestCase):
    ...
    def _create_template_file(
            self, template_dir, filename, content='test content\n'):
    ...
    def _assert_filename_pattern(self, filename):
        ...
        self.assertEqual(
            parts[0][:7],
            'catalog',
            'Filename should start with "catalog"'
        )
        self.assertGreaterEqual(
            len(parts),
            4,
            'Filename should have at least 4 parts'
        )
    ...
    def _parse_catalog_row(self, line):
        ...
        self.assertEqual(
            len(parts),
            14,
            f'Row should have 14 fields, got {len(parts)}'
        )
    ...
    def test_template_catalog_row_contract(self):
        ...
        test_rows = [
            (
                'ev_001|2020-01-01T00:00:00|45.0|10.0|10.0|TEST|TEST|TEST|'
                'TEST_1|Mw|4.0|TEST|Location 1|0.85'
            ),
            (
                'ev_002|2020-01-01T01:00:00|45.1|10.1|10.5|TEST|TEST|TEST|'
                'TEST_2|Mw|4.1|TEST|Location 2|0.87'
            ),
        ]
